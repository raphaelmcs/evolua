<x-filament-panels::page class="evolua-resource-page evolua-athletes-list">
    <section class="evolua-resource-hero evolua-resource-hero--flat">
        <div class="evolua-resource-hero-content">
            <p class="evolua-resource-kicker">Atletas</p>
            <h1 class="evolua-resource-title">Lista de atletas</h1>
            <p class="evolua-resource-subtitle">
                Gerencie cadastro, categorias e status dos atletas da sua organizacao.
            </p>
        </div>
