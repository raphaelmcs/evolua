...
@php
    ...
    $organizationLogo = $organization?->logo_path
        ? \Illuminate\Support\Facades\Storage::disk('public')->url($organization->logo_path)
        : null;
    $orgEditUrl = ($user && $organization && $user->role === \App\Models\User::ROLE_OWNER)
        ? route('filament.admin.resources.organizations.edit', ['record' => $organization])
        : null;
    $brandLogo = asset('images/logo-evolua.png');
@endphp
...
>
    <nav
        class="relative flex h-16 items-center gap-x-4 bg-white px-4 shadow-sm ring-1 ring-gray-950/5 dark:bg-gray-900 dark:ring-white/10 md:px-6 lg:px-8"
    >
        ...
        <div class="evolua-topbar-center">
            <img src="{{ $brandLogo }}" alt="Evolua" class="evolua-topbar-logo">
        </div>
